...
import StudyModeAssessmentKit from '../components/StudyModeAssessmentKit';
...
const StudyMode = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Header title="The History of Psychology" isStudyMode={true} />
      <div className="flex">
        <SideNav />
          ...
          <div className="bg-white p-6">
            ...
            <div className="space-y-6">
              ...
              <StudyModeAssessmentKit
                ...
                index={0}
                completedDate={assessmentData[0].completedDate}
              />
              ...
              <StudyModeAssessmentKit
                ...
                index={1}
                completedDate={assessmentData[1].completedDate}
              />
              ...
              <StudyModeAssessmentKit
                ...
                index={2}
                completedDate={assessmentData[2].completedDate}
              />
            </div>
